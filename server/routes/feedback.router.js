...
router.post('/', (req, res) => {
  ...
  const queryText = `INSERT INTO "feedback"() VALUES ($1, $2, $3, $4);`;
  pool.query(queryText, [feedbackToDatabase.input1, feedbackToDatabase.input2, feedbackToDatabase.input3, feedbackToDatabase.input4])
    .then((result)=>{
        res.sendStatus(201);
    })
    .catch((error)=>{
